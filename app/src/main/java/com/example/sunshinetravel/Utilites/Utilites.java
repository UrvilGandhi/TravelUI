...
////        TinyDB tinyDB = new TinyDB((Activity) context);
//        tv_title.setText(title);

//        if (fragment == null) {
//            toolbarTop.setNavigationIcon(R.drawable.back);
//            toolbarTop.setNavigationOnClickListener(v -> {
//                MenuClickListener updateMyEventsInterface = (MenuClickListener) context;
//                updateMyEventsInterface.onMenuClick(MENU_BACK);
//            });
//        }
    ...
    public static String printDateDifference(String startDate) {
        ...
        Calendar cal = Calendar.getInstance();
        TimeZone tz = cal.getTimeZone();
        SimpleDateFormat dateFormatterGMT = new SimpleDateFormat("dd/MM/yyyy HH:mm");
        dateFormatterGMT.setTimeZone(tz);
    ...
    public static boolean isBeforeDate(String date) {
        ...
        @SuppressLint("SimpleDateFormat") SimpleDateFormat sdf = new SimpleDateFormat(inputDatePattern);
        Date date11;
